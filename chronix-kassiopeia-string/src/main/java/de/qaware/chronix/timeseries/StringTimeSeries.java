 ...
 */
public final class StringTimeSeries implements Serializable {
    ...
    public static final class Builder {
        ...
        public Builder(String metric) {
            stringTimeSeries = new StringTimeSeries();
            stringTimeSeries.metric = metric;
        }
        ...
        public Builder points(LongList timestamps, ArrayList<String> values) {
            if (timestamps != null && values != null) {
                stringTimeSeries.setAll(timestamps, values);
            }
            return this;
        }
        ...
        public Builder point(long timestamp, String value) {
            stringTimeSeries.timestamps.add(timestamp);
            stringTimeSeries.values.add(value);
            return this;
        }
        ...
        public Builder attribute(String key, Object value) {
            stringTimeSeries.addAttribute(key, value);
            return this;
        }
        ...
        public Builder attributes(Map<String, Object> attributes) {
            stringTimeSeries.attributes = attributes;
            return this;
        }
