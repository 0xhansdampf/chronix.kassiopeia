 ...
 */
public class JsonKassiopeiaStringSerializer {
     ...
     */
    public byte[] toJson(StringTimeSeries timeSeries) {
     ...
     */
    public void fromJson(byte[] json, final long queryStart, final long queryEnd, StringTimeSeries.Builder builder) {
        ...
        try {
            ...
            List<String> values = (List<String>) timestampsValues[1];
